<?php
/*
Plugin Name: SAR Validar NIF en Gravity Forms
Description: Valida el NIF introducido en campos de línea de texto con la clase CSS validar_nif
Version: 1.0
...
add_filter( 'gform_field_validation', 'sar_validar_nif_en_gf', 10, 4 );
function sar_validar_nif_en_gf( $result, $value, $form, $field ) {
  
    // Comprobamos sólo los campos de línea de texto que tengan la clase CSS valida_nif
    if ( strpos( $field->cssClass, 'validar_nif' ) !== false && $field->type == 'text' ) {
